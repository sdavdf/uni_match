...
} from "../store/alojamiento/alojamientoApi";
...
const Dashboard = () => {
  ...
  const {
    ...
    isLoading,
    error,
  } = useGetAlojamientosQuery(filters);
      ...
      <div className="dashboard-main">
        ...
        <main className="content-area">
          ...
          <div className="content-tabs">
            ...
            <button
              className={`tab-btn ${
                activeTab === "mis-publicaciones" ? "active" : ""
              }`}
            ...
            {activeTab === "explorar" && (
              <div className="sort-options">
                <select
                  value={filters.orden}
                  onChange={(e) =>
                    setFilters({ ...filters, orden: e.target.value })
                  }
          ...
          {/* Empty State */}
          {!isLoading &&
            (activeTab === "explorar" ? alojamientos : misPublicaciones)
              ?.length === 0 && (
